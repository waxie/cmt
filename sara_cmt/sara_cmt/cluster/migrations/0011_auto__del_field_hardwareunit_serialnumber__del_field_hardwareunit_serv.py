...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'HardwareUnit.serialnumber'
        db.delete_column('cluster_hardwareunit', 'serialnumber')

        # Deleting field 'HardwareUnit.service_tag'
        db.delete_column('cluster_hardwareunit', 'service_tag')


    def backwards(self, orm):
        
        # Adding field 'HardwareUnit.serialnumber'
        db.add_column('cluster_hardwareunit', 'serialnumber', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'HardwareUnit.service_tag'
        db.add_column('cluster_hardwareunit', 'service_tag', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
