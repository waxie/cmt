...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HardwareUnit.first_slot'
        db.alter_column('cluster_hardwareunit', 'first_slot', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'HardwareUnit.first_slot'
        db.alter_column('cluster_hardwareunit', 'first_slot', self.gf('django.db.models.fields.PositiveIntegerField')())
