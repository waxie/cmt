...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'HardwareUnit', fields ['cluster', 'label']
        db.create_unique(u'cluster_hardwareunit', ['cluster_id', 'label'])
        ...
        # Changing field 'Network.gateway'
        db.alter_column(u'cluster_network', 'gateway', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))

        # Changing field 'Interface.ip'
        db.alter_column(u'cluster_interface', 'ip', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))

    def backwards(self, orm):
        # Removing unique constraint on 'HardwareUnit', fields ['cluster', 'label']
        db.delete_unique(u'cluster_hardwareunit', ['cluster_id', 'label'])

        # Deleting field 'Network.cidr'
        db.delete_column(u'cluster_network', 'cidr')


        # Changing field 'Network.gateway'
        db.alter_column(u'cluster_network', 'gateway', self.gf('django.db.models.fields.IPAddressField')(max_length=15))

        # Changing field 'Interface.ip'
        db.alter_column(u'cluster_interface', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15))
