...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Interface', fields ['ip', 'network']
        db.delete_unique('cluster_interface', ['ip', 'network_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Interface', fields ['ip', 'network']
        db.create_unique('cluster_interface', ['ip', 'network_id'])
    ...
    models = {
        ...
        'cluster.interface': {
            'Meta': {'unique_together': "(('network', 'hwaddress'),)", 'object_name': 'Interface'},
