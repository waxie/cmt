...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cluster_interface', 'hwaddress', self.gf('django.db.models.fields.CharField')(unique=True, max_length=17, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Interface.hwaddress'
        db.alter_column('cluster_interface', 'hwaddress', self.gf('django.db.models.fields.CharField')(unique=True, max_length=17, null=True, blank=True))
