...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HardwareUnit.warranty_tag'
        db.add_column('cluster_hardwareunit', 'warranty_tag', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HardwareUnit.warranty_tag'
        db.delete_column('cluster_hardwareunit', 'warranty_tag')
