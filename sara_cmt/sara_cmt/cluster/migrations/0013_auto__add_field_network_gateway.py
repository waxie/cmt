...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cluster_network', 'gateway', self.gf('django.db.models.fields.IPAddressField')(default='0.0.0.0', max_length=15, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Network.gateway'
        db.delete_column('cluster_network', 'gateway')
