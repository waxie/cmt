...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Connection.address'
        db.alter_column('cluster_connection', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['cluster.Address']))


    def backwards(self, orm):
        
        # Changing field 'Connection.address'
        db.alter_column('cluster_connection', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cluster.Address']))
