...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HardwareUnit.seller'
        db.add_column('cluster_hardwareunit', 'seller', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sold', null=True, to=orm['cluster.Connection']), keep_default=False)

        # Adding field 'HardwareUnit.owner'
        db.add_column('cluster_hardwareunit', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owns', null=True, to=orm['cluster.Connection']), keep_default=False)

        # Adding field 'HardwareUnit.state'
        db.add_column('cluster_hardwareunit', 'state', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=3, null=True, blank=True), keep_default=False)

        # Adding field 'HardwareUnit.serial_number'
        db.add_column('cluster_hardwareunit', 'serial_number', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'HardwareModel.vendorcode'
        db.add_column('cluster_hardwaremodel', 'vendorcode', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'WarrantyContract.contract_number'
        db.add_column('cluster_warrantycontract', 'contract_number', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'WarrantyContract.annual_cost'
        db.add_column('cluster_warrantycontract', 'annual_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HardwareUnit.seller'
        db.delete_column('cluster_hardwareunit', 'seller_id')

        # Deleting field 'HardwareUnit.owner'
        db.delete_column('cluster_hardwareunit', 'owner_id')

        # Deleting field 'HardwareUnit.state'
        db.delete_column('cluster_hardwareunit', 'state')

        # Deleting field 'HardwareUnit.serial_number'
        db.delete_column('cluster_hardwareunit', 'serial_number')

        # Deleting field 'HardwareModel.vendorcode'
        db.delete_column('cluster_hardwaremodel', 'vendorcode')

        # Deleting field 'WarrantyContract.contract_number'
        db.delete_column('cluster_warrantycontract', 'contract_number')

        # Deleting field 'WarrantyContract.annual_cost'
        db.delete_column('cluster_warrantycontract', 'annual_cost')
    ...
    models = {
        ...
        'cluster.hardwareunit': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'updated_on': ('django_extensions.db.fields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'cluster.interface': {
            'Meta': {'unique_together': "(('network', 'ip'),)", 'object_name': 'Interface'},
        ...
        'cluster.rack': {
            'Meta': {'unique_together': "(('room', 'label'),)", 'object_name': 'Rack'},
