...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HardwareUnit.state'
        db.alter_column('cluster_hardwareunit', 'state', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'HardwareUnit.state'
        db.alter_column('cluster_hardwareunit', 'state', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True))
