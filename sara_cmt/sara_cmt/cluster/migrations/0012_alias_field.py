...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Interface.aliases'
        db.add_column('cluster_interface', 'aliases', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Interface.aliases'
        db.delete_column('cluster_interface', 'aliases')
