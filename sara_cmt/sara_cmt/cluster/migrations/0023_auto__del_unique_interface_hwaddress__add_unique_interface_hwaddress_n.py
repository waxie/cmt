...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Interface', fields ['hwaddress']
        db.delete_unique('cluster_interface', ['hwaddress'])

        # Adding unique constraint on 'Interface', fields ['hwaddress', 'network']
        db.create_unique('cluster_interface', ['hwaddress', 'network_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Interface', fields ['hwaddress']
        db.create_unique('cluster_interface', ['hwaddress'])

        # Removing unique constraint on 'Interface', fields ['hwaddress', 'network']
        db.delete_unique('cluster_interface', ['hwaddress', 'network_id'])
    ...
    models = {
        ...
        'cluster.interface': {
            'Meta': {'unique_together': "(('network', 'ip'), ('network', 'hwaddress'))", 'object_name': 'Interface'},
