...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cluster_interface', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15))


    def backwards(self, orm):
        
        # Changing field 'Interface.ip'
        db.alter_column('cluster_interface', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True))
